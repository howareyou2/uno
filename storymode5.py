...
#캐릭터가 screen밖으로 못넘어가게 설정
    ...
    #캐릭터와 airplane이 충돌하면 캐릭터의 위치가 멈추게 설정, airplane위에 텍스트 출력
    if char_x + char_width > airplane_x and char_x < airplane_x + airplane_width and char_y + char_height > airplane_y and char_y < airplane_y + airplane_height:
        char_x -= move_x
        char_y -= move_y
        airplane_text = font.render("Finish: ENTER!", True, (0, 0, 0))
        screen.blit(airplane_text, (airplane_x, airplane_y - 20))
