...
while running:
    ...
    #캐릭터와 flower이 충돌하면 캐릭터의 위치가 멈추게 설정, flower위에 텍스트 출력
    if char_x + char_width > flower_x and char_x < flower_x + flower_width and char_y + char_height > flower_y and char_y < flower_y + flower_height:
        char_x -= move_x
        char_y -= move_y
        flower_text = font.render("Camellia Hill: ENTER!", True, (0, 0, 0))
        screen.blit(flower_text, (flower_x, flower_y - 20))
